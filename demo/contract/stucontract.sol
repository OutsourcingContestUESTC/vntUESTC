...
contract stucontract {
    ...
    function StringhashCompareInternal(string memory a, string memory b) internal view returns (bool) {
        return keccak256(abi.encodePacked(a)) == keccak256(abi.encodePacked(b));
    }

    function addressCompareInternal(address _a1,address _a2) internal view returns (bool){
        return  _a1==_a2;    
    }
    
    function CerticateVerification (uint64 ID,string memory infohash) public view returns (bool) {
    ...
    function SchoolConfirm (string memory schoolname,address ScPk) internal view returns (bool) {
        return addressCompareInternal(ScPkMap[schoolname],ScPk);
    }

    function CertificateExist(string memory InfoH) internal view returns (uint64) {        
    ...
    function SchoolExist(string memory schooln) internal view returns (bool) {
        address _a;
