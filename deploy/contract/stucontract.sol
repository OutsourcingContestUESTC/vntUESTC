...
contract stucontract {
    ...
    function addressCompareInternal(address _a1, address _a2)
        internal
        returns (bool)
    {
        return _a1 == _a2;
    ...
    function SchoolConfirm(string memory schoolname, address ScPk)
        internal
        returns (bool)
    {
    ...
    function SchoolRegister(string memory SchoolIn)
        public
        admin
        returns (bool)
    {
    ...
    function RegisterFunc(
        string memory scname,
        string memory infohash,
        uint256 now_
    ) public returns (string memory _state, uint64 _id) {
        address scpk;
        scpk = msg.sender;
